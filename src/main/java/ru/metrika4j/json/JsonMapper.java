...
/**
 * Обработчик JSON: парсинг, сериализация/десериализация Java объектов. Через этот интерфейс происходит
 * чтение данных, полученных от серверов Я.Метрики, и формирование данных для отправки на сервера.
 *
 * @author Artur Suilin
 */
